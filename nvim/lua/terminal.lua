...
function M.setup()
  ...
  -- Terminal mode
  map('t', '<leader>q', '<C-\\><C-n>:lua require("terminal").close_and_jump()<CR>', 'Close terminal and jump to code')
  map('t', '<leader>t', '<C-\\><C-n>:lua require("terminal").toggle()<CR>', 'Toggle terminal off')
  map('t', '<leader>]', '<C-\\><C-n>:lua require("terminal").next()<CR>', 'Next terminal')
  map('t', '<leader>[', '<C-\\><C-n>:lua require("terminal").prev()<CR>', 'Previous terminal')
  map('t', '<leader>c', '<C-\\><C-n>:lua require("terminal").clear_terminal()<CR>i', 'Clear terminal completely')
