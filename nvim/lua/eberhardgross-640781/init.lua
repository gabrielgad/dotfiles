-- eberhardgross-640781 colorscheme for Neovim
-- Generated from: /home/gabe/Pictures/wallpapers/pexels-eberhardgross-640781.jpg
...
M.palette = {
  ...
  bright_red = "#E1C44E",
  bright_green = "#E0C7BD",
  bright_yellow = "#E3C859",
  bright_blue = "#DBBCB0",
  bright_magenta = "#A1C162",
  bright_cyan = "#A1C162",
  bright_white = "#EBEAEA",
}
...
function M.setup()
  ...
  vim.g.colors_name = "eberhardgross-640781"
